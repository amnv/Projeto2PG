...
public class Auxiliar {
	...
	static Ponto perturbarNormal(Ponto A,Ponto B, Ponto N, double rugosidade){
		Ponto resp = new Ponto(0,0,0);
		Random random = new Random();
		double r1, r2, r3;
		r1 = (double) (Math.random() * rugosidade);
		r2 = (double) (Math.random() * rugosidade);

		N.x = ( (B.x * r1) + (A.x * r2) ) + N.x; 
		N.y = ( (B.y * r1) + (A.y * r2) ) + N.y; 
		N.z = ( (B.z * r1) + (A.z * r2) ) + N.z;
